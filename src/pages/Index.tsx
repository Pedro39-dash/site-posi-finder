      ...
      <section className="py-16">
            <div className="container mx-auto px-4">
              ...
              <div>
                ...
                <p className="max-width-[1026px] text-zinc-500 mt-1"> 
