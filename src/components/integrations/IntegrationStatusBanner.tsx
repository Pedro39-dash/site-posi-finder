...
const IntegrationStatusBanner = ({ projectId, integrations }: IntegrationStatusBannerProps) => {
  ...
  // Don't show banner if GSC is connected (ranking data is real)
  ...
  return (
    <Alert className="mb-6 border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950">
      ...
      <AlertDescription className="flex items-center justify-between text-blue-800 dark:text-blue-200">
        <div>
          <strong>Dados Simulados:</strong> Conecte o Google Search Console para obter dados reais de posições, impressões e cliques.
        </div>
        <Button
          size="sm"
          variant="outline"
