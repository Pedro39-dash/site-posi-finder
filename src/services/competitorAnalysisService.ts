...
export const CompetitorAnalysisService = {
  ...
  /**
   * Lista as análises de um utilizador, com opção de filtrar por projeto.
   */
  getUserAnalyses: async (
    limit: number,
    projectId?: string // <<< ALTERAÇÃO AQUI
  ...
  cancelAnalysis: async (analysisId: string): Promise<{ success: boolean; error?: string }> => {
    try {
      ...
      // Aqui, pode ser necessário chamar uma edge function para parar o processo
